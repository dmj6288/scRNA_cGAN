...
def plot_images_from_tensor(image_tensor, epoch, fake, num_images=25, size=(1, 28, 28), nrow=5, show=True):
    """
    ...
    plt.savefig("/home/dennis00/scRNA_GAN/cGAN_exports/images_from_tensor/" + str(epoch) + fake + ".png", bbox_inches='tight')
